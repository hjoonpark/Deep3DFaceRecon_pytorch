...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--use_aug', type=util.str2bool, nargs='?', const=True, default=False, help='whether use data augmentation')
        ...
        parser.add_argument('--save_epoch_freq', type=int, default=10000, help='frequency of saving checkpoints at the end of epochs')
